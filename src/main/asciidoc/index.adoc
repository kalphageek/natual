...
operation::get-events[snippets='http-request,request-parameters,response-fields,http-response,links']
...
operation::create-event[snippets='request-fields,http-request,response-fields,http-response,links']
...
operation::get-event[snippets='request-fields,http-request,http-response,links']
...
operation::update-event[snippets='request-fields,http-request,http-response,links']
